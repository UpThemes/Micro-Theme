 ...
 * the author archive index context only, via "header-author.php"
 */
get_header( 'author' ); 
?>

	<h1><?php echo _e('Author Archives:'); wp_title(''); ?></h1>
    ...
    <ul id="posts">
		...
		* via "content.php", or in the author archive index context only, via 
		* "content-author.php"
		*/
 ...
 * the author archive index context only, via "footer-author.php"
 */
get_footer( 'author' ); 
?>