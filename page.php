 ...
 * the static page context only, via "header-page.php"
 */
get_header( 'page' ); 
?>
	...
	<?php 
		...
		* via "content.php", or in the static page context only, via 
		* "content-page.php"
		*/
 ...
 * the static page context only, via "footer-page.php"
 */
get_footer( 'page' ); 
?>