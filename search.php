 ...
 * the search results index context only, via "header-search.php"
 */
get_header( 'search' ); 
?>
    ...
    <ul id="posts">
		...
		* via "content.php", or in the search results index context only, via 
		* "content-search.php"
		*/
 ...
 * the search results index context only, via "footer-search.php"
 */
