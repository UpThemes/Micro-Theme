 ...
 * the single blog post context only, via "header-single.php"
 */
get_header( 'single' ); 
?>
	...
	<?php 
		...
		* via "content.php", or in the single blog post context only, via 
		* "content-single.php"
		*/
 ...
 * the single blog post context only, via "footer-single.php"
 */
get_footer( 'single' ); 
?>