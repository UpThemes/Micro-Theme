 ...
 * the tag archive index context only, via "header-tag.php"
 */
get_header( 'tag' ); 
?>
	<h1><?php echo _e('Posts by Tag:'); wp_title(''); ?></h1>
    ...
    <ul id="posts">
		...
		* via "content.php", or in tag archive index context only, via 
		* "content-tag.php"
		*/
 ...
 * the tag archive index context only, via "footer-tag.php"
 */
get_footer( 'tag' ); 
?>